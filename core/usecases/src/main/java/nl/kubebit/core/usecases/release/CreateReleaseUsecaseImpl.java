...
public class CreateReleaseUsecaseImpl implements CreateReleaseUsecase {
    ...
    public ReleaseResponse execute(String projectId, String enviromentName, ReleaseCreateRequest request) {
        ...
        //
        Map<String, Object> values = sanitizeValues(template.formSchema(), request.values());
     ...
     * @return
     */
    private Map<String, Object> sanitizeValues(Map<String, Object> form, Map<String, Object> values) {
        return null;
    }
}
